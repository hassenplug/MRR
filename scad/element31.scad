...
arr_r_in   = lg_r_bore + 0.04;      // 0.56
arr_r_out  = lg_r_root - 0.05;      // 0.79
arr_r_mid  = (arr_r_in + arr_r_out) / 2;
arr_head_h      = 0.20;
arr_head_w      = arr_r_out - arr_r_in;   // full band width at arrowhead
arr_shaft_w     = 0.22;                    // shaft radial width (narrower than head)
...
module rotation_arrows() {
    ...
    union() {
        for (i = [0:3]) {
            ...
            // Full-width arrowhead at the clockwise end

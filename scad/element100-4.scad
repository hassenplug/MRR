// element100-4.scad
// Flag square tile variant — gear with pennant flag, number "4" on flag.
...
union() {                                           // step 5: add label
    difference() {
                        ...
                        union() {                   // step 2: add gear bore
                            difference() {
                                union() {           // step 1: add gear
                                    difference() {
                                        plate(["red", "red", "red", undef, "red", "red"]);   // step 0: plate (frame + rivets)
        ...
        label_holes("4");                                   // cut label hole
    }
    flag_label("4");                                        // fill with label
}

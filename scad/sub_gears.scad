...
//   plate_colors — 6-slot frame color array (see sub_base_plate.scad)
//   gear_color   — fill color for both gears ("green" for element31, "red" for element32)
//   sg_angle     — angle (deg) from the large gear center to the small gear center
//   sg_phase     — small gear rotation (deg) so its teeth mesh with the large gear
//   clockwise    — rotation-arrow direction: true = clockwise, false = counter-clockwise
//

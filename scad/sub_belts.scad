...
//   straight      — true for the straight belt tiles (10, 20), false for the
//                   curved turn tiles (11, 12, 21, 22)
...
//
// All belt/roller/arrow geometry constants live here — identical across all
// six tiles except where straight/double_speed pick a family-specific value.
// element12/22 are mirrors of element11/21 — same constants and modules, the
// calling file's assembly wraps the whole thing in translate()/mirror()
// instead of defining separate geometry.
...
// Turn-tile curve geometry — unused (harmless) on straight tiles
cx      = plate_w / 2;
r_curve = 0.48;
cx_r    = cx + r_curve;
